...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        bindPreferenceSummaryToValue(findPreference("api_token"));
    ...
    private static Preference.OnPreferenceClickListener sBindPreferenceClickListener = new Preference.OnPreferenceClickListener() {
        ...
        public boolean onPreferenceClick(Preference preference) {
            ...
            api.execute(url, "TODO");
            /*
            if(!text.equals("Error")) {
                try{
                    JSONObject response = new JSONObject(text);
                    text = response.get("message").toString();
                } catch(Exception ex){
                    text = "Check Url";
                }

                Toast.makeText(preference.getContext(), text, Toast.LENGTH_SHORT).show();
            }*/
